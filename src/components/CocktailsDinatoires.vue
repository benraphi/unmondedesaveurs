...
.imgfond {
    margin: 0;
    padding: 0;
    background: url("../../static/img/pages/verrines.jpeg") no-repeat center fixed;
...
<template>
    <div>
        ...
        <div style="text-align:left;padding-left:20vw">
            <h2>32€ par personne.<br>Minimum 15 personnes. En livraison.</h2>
            ...
            <p>
                Verrine de confit d'ananas, crème de mascarpone à la vanille et broyé de
                spéculoos.<br>
                Verrine mousse chocolat noir, craquant au chocolat blanc et griottes.<br>
                Verrine mousse chocolat blanc, craquant au chocolat noir et griottes.<br>
