...
<template>
  <div>
    ...
    <p><i>Un monde de saveurs</i> vous propose plusieurs thèmes pour vos cours de cuisine :</p>
    <p>Mises en bouche ; Soupe, Velouté, Consommé, Gaspacho....; Entrées froides ; Entrées chaudes ; Tartes salées ; Cuisson des légumes ; Pâtes fraîches ; Confection d'une sauce ; Sucré-Salé ; Plat à base d'épices ; Poissons, Crustacés, Coquillages.... ; Viandes, Volailles, Gibiers....; Pâte sucré de base ; Tarte sucré, Crumble....; Dessert à base de mousse....</p>
    <p>Mais, si vous avez d'autres idées, n'hésitez pas à proposer d'autres thèmes!!</p>
